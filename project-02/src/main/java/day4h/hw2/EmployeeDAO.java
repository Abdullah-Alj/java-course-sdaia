...
public class EmployeeDAO {
    private static final String url = "jdbc:sqlite:C:\\Users\\dev\\IdeaProjects\\project-02\\src\\main\\java\\day4h\\hw2\\hw2.db";
    ...
    public ArrayList<Employee> selectAll() throws SQLException{
        Connection connection =DriverManager.getConnection(url);
        PreparedStatement st = connection.prepareStatement(SELECT_ALL_employee);
